...
# configuring catalogue component
...
# creating AMI from catalogue instance
...
# Launch template creation using catalogue_ami
...
# backend alb listener rule for catalogue target group
